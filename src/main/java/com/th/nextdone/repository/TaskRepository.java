...
public interface TaskRepository extends JpaRepository<Task, Long> {
	...
	//Pesquisar por Data
	@Query("SELECT t From Task t WHERE t.dataCreation = :data")
	...
	List<Task> searchBeetwenPeriod(@Param(value = "firstDate")LocalDate firstDate, @Param(value = "lastDate")LocalDate lastDate);
